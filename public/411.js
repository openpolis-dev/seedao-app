"use strict";
(self["webpackChunk_uniswap_widgets"] = self["webpackChunk_uniswap_widgets"] || []).push([[411],{
...
var enUS = {
  messages: {
    ...
    "{0} approval failed": [["0"], " approval failed"],
    "{0} {1}": [["0"], " ", ["1"]],
    ...
    "{symbol} permit allowance failed: {0}": [["symbol"], " permit allowance failed: ", ["0"]],
    "{symbol} token allowance failed: {0}": [["symbol"], " token allowance failed: ", ["0"]],
    "{title}": [["title"]]
  }
};
